...
import { CalendarDays, ClipboardPlus, UserPlus, Activity, Sparkles, HeartPulse, FolderSearch } from "lucide-react";

const quickCards = [
  {
    title: "Abrir agenda",
    description: "Ver citas de fisioterapia y abrir la atención clínica.",
    href: "/fisioterapia/agenda",
    icon: CalendarDays,
  },
  {
    title: "Crear nuevo cliente",
    description: "Registrar un cliente nuevo desde cero para el área.",
    href: "/fisioterapia/nuevo",
    icon: UserPlus,
  },
  {
    title: "Agendar cita",
    description: "Programar una cita de fisioterapia de forma rápida.",
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-7 text-[#496356] md:text-[15px]">
                Accede a agenda, creación de clientes y atención fisioterapéutica con una
                interfaz más clara, más elegante y coherente con la marca Prevital.
              </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-[#51695C]">
                  Entra al flujo que necesitas y sigue trabajando.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="rounded-[32px] border border-[#CFE4D8] bg-[linear-gradient(180deg,_rgba(255,255,255,0.96)_0%,_rgba(247,252,248,0.98)_100%)] p-6 shadow-[0_24px_60px_rgba(95,125,102,0.12)]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#24312A]">Estructura del módulo</h2>
                  <p className="mt-1 text-sm leading-6 text-[#51695C]">
                    Pensado para trabajar ordenado y con continuidad clínica.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-5 rounded-[28px] border border-[#D7EADF] bg-[linear-gradient(135deg,_#F7FCF8_0%,_#EEF8F2_62%,_#E4F3EA_100%)] p-6 text-sm leading-7 text-[#51695C] shadow-inner">
                Incluye agenda, nuevo cliente, agendamiento y atención con trazabilidad
                desde recepción y comercial.
              </div>
            </div>
            ...
            <div className="rounded-[32px] border border-[#CFE4D8] bg-[linear-gradient(135deg,_#F4FBF6_0%,_#FFFFFF_100%)] p-6 shadow-[0_24px_60px_rgba(95,125,102,0.1)]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#24312A]">Ruta sugerida</h3>
                  <p className="mt-1 text-sm text-[#607368]">
                    Un flujo simple para mantener orden operativo.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-5 grid gap-3">
                {[
                  ...
                  "Programar o abrir cita",
                  "Registrar atención fisioterapéutica",
                  "Guardar plan e indicaciones",
                ].map((step, index) => (
                  <div
                    key={step}
